...
def implement_llama_3_3_model():
    ...
    """
    # TODO: Your implementation here
    llm = ChatGroq(temperature=0.3, model="llama-3.3-70b-versatile", max_retries=2)
    return llm
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama4Model = implement_llama_4_model()
    llama33Model = implement_llama_3_3_model()
    return {
        "llama4Model": implement_query_model(llama4Model, prompt),
        "llama3Model": implement_query_model(llama33Model, prompt)
    }
