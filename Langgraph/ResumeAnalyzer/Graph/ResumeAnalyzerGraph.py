...
def grammer_validation_check(state: ResumeState):
    ...
    if grammer_mistake_present is True:
        return FIX_GRAMMER_NODE
    return ATS_RESUME_VALIDATOR_NODE
...
flow.add_conditional_edges(
    ...
    path_map={
        FIX_GRAMMER_NODE: FIX_GRAMMER_NODE,
        ATS_RESUME_VALIDATOR_NODE: ATS_RESUME_VALIDATOR_NODE,
    },
)
...
if __name__ == "__main__":
    ...
    resume_content = """
        ...
        ------------------------------------------------------
    """
    response = app.invoke(input={"resume_content": resume_content})
    print("\n *** Original resume content ***")
    print("+" * 50)
    print(response["resume_content"])
    print("+" * 50)
    print("\n *** Resume ATS Score ***")
    print(response["ats_resume_score"])
    print("+" * 50)
    print("\n *** Improved resume content ***")
    print(response["improved_content"])
    print("+" * 50)
